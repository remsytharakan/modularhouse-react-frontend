    ...
    <div>
      <Grid container spacing={5}>
        <Grid item xs={12} md={8} lg={8} >
            <Box  paddingLeft={{ xs: '0px', sm: '40px', md: '80px', lg: '90px' }} paddingRight={{xs:'150px'}} marginTop='5%'>
          <Box bgcolor="#fbe9e7" paddingLeft='0%' display="flex" flexDirection="row" alignItems="center" justifyContent="center" paddingTop="1%" >
        ...
        <Grid item xs={12} md={4}>
            <Box  paddingRight={{ xs: '35px', sm: '60px', md: '80px', lg: '100px' }}  marginTop='10%'>
